...
<div class="book_wrapper">
        ...
        <tr>
            <th><b><i>Title</i></b></th>
            <th><b><i>Author</i></b></th>
            <th><b><i>Publisher</i></b></th>
            <th><b><i>Website</i></b></th>
        </tr> 
${booksData.map(bookTable).join("")}
      <tbody>
        </table>
    </div>
<p class="footer"> These ${
  booksData.length
} books  were added recently, check back latter to see if more are added</p>
